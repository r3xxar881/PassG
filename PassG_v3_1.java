		...
		public static void generar(int x, String cad) //Todo el codigo que genera la cadena o contraseña esta en un procedimiento la cual es llamada mas tarde teniendo en cuenta la cantidad de digitos que quiere el usuario en su contraseña mayores a 8.
			{
				...
				//Ciclo for que realiza x veces una concatenacion de caracteres al azar que los toma segun la posicion con respecto al numero random que generamos.
				for(int i = 0; i < x; i++)
					{
		...
		public static void main(String args[])
			{
				...
				System.out.println("	?8P                                  `?8888P   By r3xx_");
																   ...
																   // "\u00f1" = ñ en ASCII.
				System.out.println("\n*Puede usar PassG_v3.1 para generar contrase\u00f1as aleatorias de la cantidad de digitos que quiera.\n");
				...
				switch(eleccion)
					{
						case 1: do{	
								...
								switch(eleccion2)
									{
										case 4: doWhileFinal(cantDigitos, elementosLetraMinMay);
												break;
												
										case 5: doWhileFinal(cantDigitos, elementosLetraMay);
												break;
												
										case 6: doWhileFinal(cantDigitos, elementosLetraMin);
												break;
										
										/*default: System.out.println("Opcion no valida");
												break;*/ //no es necesario este break devido a que mientras el numero u opccion sean erroneos, no pasa del do-while.
									}
								break;
						
						case 2: doWhileFinal(cantDigitos, elementosNum);
								break;
						
						case 3: doWhileFinal(cantDigitos, elementos);
								break;
				...
				//CODIGO NO UTILIZADO, PERO SIN ELIMINAR...
